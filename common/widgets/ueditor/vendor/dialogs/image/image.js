    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
				...
				imageCompressWidth = editor.getOpt('imageCompressWidth'),
				imageCompressHeight = editor.getOpt('imageCompressHeight'),
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                compress: editor.getOpt('imageCompressEnable') ? {
                    width: imageCompressWidth,
                    height: imageCompressHeight,
